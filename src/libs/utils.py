...
def load_paired_img_wrd(folder, word_vectors, use_word_vectors=True):
    ...
    '''
    img_data: 1000 ảnh 224 * 224 * 3
    labels_list: nhãn của các ảnh đã được chuyển qua vector sử dụng bộ pre-train glove.6B.300d
    paths_list: link lưu trữ ảnh 
    '''
